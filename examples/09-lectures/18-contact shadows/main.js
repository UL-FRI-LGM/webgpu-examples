...
const pass1Pipeline = device.createRenderPipeline({
    ...
    fragment: {
        ...
        entryPoint: 'main',
        targets: [{ format: 'bgra8unorm', },], // was: format
    },
    depthStencil: {
...
let gBufferTextureAlbedo = device.createTexture({
...
function render() {
    ...
    const lightPositionView = vec3.create();
    ...
    queue.writeBuffer(fragUniformBuffer, 64, invProjectionMatrix);
    queue.writeBuffer(fragUniformBuffer, 128, lightPositionView);
