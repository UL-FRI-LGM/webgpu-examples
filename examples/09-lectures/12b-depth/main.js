...
const vertexBuffer = WebGPU.createBuffer(device, {
    ...
    data: new Float32Array([
        ...
        1,  -1, -1,  1,      1,  0,  0,  1,    //   2
        0,  1,  -1,  1,      0,  1,  0,  1,    //   3
        -0.5, -1, -1.001,  1,      1,  0,  0,  1,    //   0
        1.5,  -1, -1.001,  1,      0,  1,  0,  1,    //   2
        0.5,  1,  -1.001,  1,      0,  0,  1,  1,    //   3
    ]),
});
...
function resize({ displaySize: { width, height }}) {
    ...
    mat4.perspectiveZO(projectionMatrix, Math.PI / 3, width / height, 0.01, 100); // ze pri 0.01 je lahko problem
}
