...
@group(3) @binding(3) var decalTexture: texture_2d<f32>;
@group(3) @binding(4) var decalSampler: sampler;
...
fn fragment(input: FragmentInput) -> FragmentOutput {
    ...
    let decalColor = textureSample(decalTexture, decalSampler, shadowTexcoords.xy);
    let decalFactor = vec4(decalColor.rgb * decalColor.a, decalColor.a) * shadowFactor;

    let finalColor = baseColor + decalFactor;
